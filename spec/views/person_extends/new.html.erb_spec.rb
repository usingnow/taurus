...
describe "person_extends/new.html.erb" do
  before(:each) do
    assign(:person_extend, stub_model(PersonExtend,
      :person_no => "MyString",
      :role_no => "MyString",
      :email => "MyString",
      :name => "MyString",
  ...
  it "renders new person_extend form" do
    render

    # Run the generator again with the --webrat flag if you want to use webrat matchers
    assert_select "form", :action => person_extends_path, :method => "post" do
