...
describe "station_procedureships/edit.html.erb" do
  before(:each) do
  ...
  it "renders the edit station_procedureship form" do
    render

    # Run the generator again with the --webrat flag if you want to use webrat matchers
    assert_select "form", :action => station_procedureships_path(@station_procedureship), :method => "post" do
