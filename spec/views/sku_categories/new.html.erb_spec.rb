...
describe "sku_categories/new.html.erb" do
  before(:each) do
    assign(:sku_category, stub_model(SkuCategory,
      :root_id => 1,
      :parent_in => 1,
      :number => "MyString",
      :name => "MyString",
  ...
  it "renders new sku_category form" do
    render

    # Run the generator again with the --webrat flag if you want to use webrat matchers
    assert_select "form", :action => sku_categories_path, :method => "post" do
