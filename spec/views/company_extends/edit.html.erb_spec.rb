...
describe "company_extends/edit.html.erb" do
  before(:each) do
  ...
  it "renders the edit company_extend form" do
    render

    # Run the generator again with the --webrat flag if you want to use webrat matchers
    assert_select "form", :action => company_extends_path(@company_extend), :method => "post" do
