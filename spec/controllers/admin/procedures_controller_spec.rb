...
describe Admin::ProceduresController do
  ...
  describe "POST create" do
    describe "with valid params" do
      it "creates a new Procedure" do
        expect {
          post :create, :procedure => valid_attributes
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested procedure" do
        ...
        Procedure.any_instance.should_receive(:update_attributes).with({'these' => 'params'})
        put :update, :id => procedure.id, :procedure => {'these' => 'params'}
      end

      it "assigns the requested procedure as @procedure" do
        procedure = Procedure.create! valid_attributes
        put :update, :id => procedure.id, :procedure => valid_attributes
        assigns(:procedure).should eq(procedure)
      end
    ...
    describe "with invalid params" do
      it "assigns the procedure as @procedure" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        Procedure.any_instance.stub(:save).and_return(false)
        put :update, :id => procedure.id, :procedure => {}
        assigns(:procedure).should eq(procedure)
      end
